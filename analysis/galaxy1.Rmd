...
Here is the overview of tasks. Please get back here when you get confused what to do next.
...
In the PDF file (If Galaxy is too slow, you can get the pdf [here](assets/handson/task2.pdf)). We will go over the first three graphs. 
...
Execute "Clustering with Race ID" with default setting on the **RDS** data after filtering (2). You can get the RDS file from [here](assets/handson/RDS.rds)
...
<details>
  <summary> **Click for result** </summary>      
![](assets/handson/heatmap.png)
</details> 

### 3-3. Marker genes
Cluster - Genes per Cluster
...
Step3
Target set: Paste the 

gene names of cluster 11 from the table (Cluster - Genes per Cluster)
...
We can see that cluster 11 looks different from other clusters in both methods.
...
Linage computation using StemID PDF report, page 1.



<details>
  <summary> **Click for result**</summary>      
![](assets/handson/network.png)
</details> 
...
Linage computation using StemID PDF report, page 3.
You will see connection between each cluster.

<details>
  <summary> **Click for result**</summary>      
![](assets/handson/lineage.png)
</details> 
